...
<div class="container">
    ...
    <div class="row justify-content-center mt-5">
        ...
        <div class="col-sm-8 mt-5">
            <p class="text-primary"><b>{{$title}}</b> <span class="badge bg-primary">{{ count($articles) }}</span></p>
            <br>
            <br>
            @foreach ($articles as $article)
            <a style="text-decoration: none;color:black" href="{{route('admin.show_article', ['article' => $article->id])}}">

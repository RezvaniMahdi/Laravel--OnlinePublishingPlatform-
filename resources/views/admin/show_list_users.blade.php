...
<div class="container">
    ...
    <div class="row justify-content-center mt-5">
        ...
        <div class="col-sm-8 mt-5">
            <p class="text-primary"><b>{{$type}}</b></p>
            <br>
            <br>
            @foreach ($users as $writer)
            <a style="text-decoration: none;color:black" href="{{ route('admin.edit_user_profile', ['user'=> $writer->id]) }}">
                <div class="card" style="border: none">
                    ...
                    <div class="card-body mt-4 mb-5">
                        ...
                        <br>
                        <p class="opacity-50">join us at :{{ $writer->created_at}}</p>
            ...
            {{$users->onEachSide(3)->links('vendor.pagination.bootstrap-5')}}

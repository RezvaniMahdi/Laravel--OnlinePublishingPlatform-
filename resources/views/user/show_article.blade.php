...
<script>
    ...
    $(document).ready(function(){
            $("#like").click(function(){
                ...
                $.ajax({
                    url: "{{ route('user.store_like',['article' => $article->id]) }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $("#comment-btn").click(function(){
                ...
                $.ajax({
                    url: "{{ route('user.store_comment',['article' => $article->id]) }}",
                    type: "POST",
                    data: formData,
                    dataType: 'json',
                    success: function(response) {
            ...
            $("#save-article").click(function(){
                ...
                $.ajax({
                    url: "{{ route('user.save_article',['article' => $article->id]) }}",
                    type: "POST",
                    dataType: 'json',
                    success: function(response) {
            ...
            $("#follow").click(function(){
                ...
                $.ajax({
                    url: "{{ route('user.follow', ['writer'=>$writer->id]) }}",
                    type: "POST",
                    dataType: 'json',
                    success: function(response) {
        ...
        <div class="row justify-content-center ">
            ...
            <div class="col-sm-8 mt-5">
                <div class="mt-3 text-primary">
                    ...
                    <a href="{{ route('user.dashbord', ['user'=> $writer->id]) }}" style="text-decoration: none"><b>Author : {{ $writer->name}}</b></a>
                    <button type="button" id="follow" name="follow" class="btn btn-primary" style="margin-left: 5%">{{$follow}}</button>
                    ...
                    <div class="row" style="display: flex">
                            <div class="col-sm-2">
                                    <div class="container" style="display: flex;z-index: 1">
                                        <span id="num-like" class="badge bg-primary">{{ count($likes) }}</span>
                            ...
                            <div class="col-sm-3">
                                <div class="container" id='comt-div' style="display: flex; z-index: 2">
                                    <span id="num-comment" class="badge bg-warning">{{ count($comments) }}</span>
                ...
                <div id="div-comment" class="col-sm-12 mt-5">
                    ...
                    {{$comments->fragment('div-comment')->onEachSide(2)->links('vendor.pagination.bootstrap-5')}}
                </div>
            </div>
